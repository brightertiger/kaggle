...
def bi_tempered_logistic_loss(activations, labels, t1=0.5, t2=2., label_smoothing=0.0001, num_iters=5):
    ...
    loss_values = loss_values.sum(dim=-1).mean()
    return loss_values
