"""
Count-based feature generation for Avito competition.

This script generates count-based features by aggregating categorical variables
across different dimensions to capture frequency patterns.
...
def generate_count_features():
    """Generate count-based aggregation features."""
    ...
    # Load active data for aggregation
    ...
    os.makedirs('../data/data/features/count', exist_ok=True)
    ...
    print("Count features generated successfully!")
